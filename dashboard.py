...
gemini_api_key = "AIzaSyBKd7wBp31RvnowzvOHYPiBVJrMclE4siM"
...
try:
    ...
    if user_input:
        ...
        st.write(answer)
        genai.configure(api_key="AIzaSyBKd7wBp31RvnowzvOHYPiBVJrMclE4siM")
        model = genai.GenerativeModel('gemini-1.5-pro')
        response = model.generate_content(f"Explain the {answer} based on above analysis")
        print(response.text)
except:
    st.write("I cant answer that question")
